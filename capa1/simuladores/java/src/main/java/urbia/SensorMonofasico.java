...
public class SensorMonofasico extends SensorBase {

    public SensorMonofasico(String deviceId, int seed) throws Exception {
        super(deviceId, seed);
    }
    ...
    protected Map<String, Object> generarValores() {
        ...
        double corriente = clamp(rng.nextDouble() * 20.0 * factor, 0.0, 20.0);
        double fp       = 0.88 + rng.nextDouble() * 0.10;
